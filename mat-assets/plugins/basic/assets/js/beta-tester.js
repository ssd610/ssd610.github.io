...
var _layout = _interopRequireDefault(__webpack_require__(634));

var BetaTesterModule = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(BetaTesterModule, _matportalModules$Vie);
  ...
  (0, _createClass2.default)(BetaTesterModule, [{
    ...
    value: function showLayout() {
      ...
      if (!always && (!matportalAdmin.config.beta_tester.option_enabled || matportalAdmin.config.beta_tester.signup_dismissed || '#tab-fontawesome4_migration' === location.hash)) {
        return;
      }
...
jQuery(function () {
  window.matportalBetaTester = new BetaTesterModule();
});
...
var _view = _interopRequireDefault(__webpack_require__(635));

var BetaTesterLayout = /*#__PURE__*/function (_matportalModules$com) {
  (0, _inherits2.default)(BetaTesterLayout, _matportalModules$com);
  ...
  (0, _createClass2.default)(BetaTesterLayout, [{
    ...
    value: function ui() {
      return {
        ...
        dontShowAgain: '.matportal-beta-tester-do-not-show-again'
      };
    }
  }, {
    key: "events",
    ...
    value: function getModalOptions() {
      return {
        id: 'matportal-beta-tester-modal',
        hide: {
    ...
    value: function getLogoOptions() {
      return {
        title: matportalAdmin.translate('beta_tester_sign_up')
      };
    }
  }, {
    key: "initialize",
    value: function initialize() {
      matportalModules.common.views.modal.Layout.prototype.initialize.apply(this, arguments);
      this.showLogo();
      this.showContentView();
      var doNotShowAgain = matportalAdmin.translate('do_not_show_again');
      this.modalHeader.currentView.ui.closeModal.after(jQuery('<div>', {
        class: 'matportal-beta-tester-do-not-show-again'
      }).text(doNotShowAgain));
    }
  }, {
    key: "showContentView",
    ...
    value: function onCloseModalClick() {
      matportalCommon.ajax.addRequest('introduction_viewed', {
        data: {
          introductionKey: matportalAdmin.config.beta_tester.beta_tester_signup
        }
      });
    }
  }]);
...
var BetaTesterView = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  function BetaTesterView() {
    ...
    _this.id = 'matportal-beta-tester-dialog-content';
    _this.template = '#tmpl-matportal-beta-tester';
    return _this;
  }
  ...
  (0, _createClass2.default)(BetaTesterView, [{
    ...
    value: function ui() {
      return {
        betaForm: '#matportal-beta-tester-form',
        betaEmail: '#matportal-beta-tester-form__email',
        betaButton: '#matportal-beta-tester-form__submit'
      };
    }
  }, {
    key: "events",
    ...
    value: function onBetaFormSubmit(event) {
      ...
      this.ui.betaButton.addClass('matportal-button-state');
      matportalCommon.ajax.addRequest('beta_tester_signup', {
        data: {
          betaTesterEmail: email
        } // Do not wait for response.

      });
      matportalBetaTester.layout.hideModal();
    }
  }, {
    key: "onRender",
