...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function initModal() {
      var modalOptions = {
        className: 'matportal-templates-modal',
        closeButton: false,
        draggable: false,
        hide: {
      ...
      this.modal = matportalCommon.dialogsManager.createWidget('lightbox', modalOptions);
...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'matportal-templates-modal__header';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-templates-modal__header';
    }
  }, {
    key: "regions",
    value: function regions() {
      return {
        logoArea: '.matportal-templates-modal__header__logo-area',
        tools: '#matportal-template-library-header-tools',
        menuArea: '.matportal-templates-modal__header__menu-area'
      };
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        closeModal: '.matportal-templates-modal__header__close'
      };
    }
  }, {
    key: "events",
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-templates-modal__header__logo';
    }
  }, {
    key: "className",
    value: function className() {
      return 'matportal-templates-modal__header__logo';
    }
  }, {
    key: "events",
    value: function events() {
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'matportal-template-library-loading';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-template-library-loading';
    }
  }]);
  return _default;
}(Marionette.ItemView);
...
var _default = window.matportalModules = {
...
// TODO: Wrong location used as `matportalModules.ForceMethodImplementation(); should be` `matportalUtils.ForceMethodImplementation()`;
...
_modules.default.common = {
  get Component() {
    // `matportalCommon` isn't available during it self initialize.
    setTimeout(function () {
      matportalCommon.helpers.softDeprecated('matportalModules.common.Component', '2.9.0', '$e.modules.ComponentBase');
    }, 2000);
  ...
  get ComponentModal() {
    // `matportalCommon` isn't available during it self initialize.
    setTimeout(function () {
      matportalCommon.helpers.softDeprecated('matportalModules.common.ComponentModal', '2.9.0', '$e.modules.ComponentModalBase');
    }, 2000);
  ...
  get HookBreak() {
    // `matportalCommon` isn't available during it self initialize.
    setTimeout(function () {
      matportalCommon.helpers.softDeprecated('matportalModules.common.HookBreak', '2.9.0', '$e.modules.HookBreak');
    }, 2000);
