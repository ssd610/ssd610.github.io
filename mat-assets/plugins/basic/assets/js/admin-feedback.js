...
(function ($) {
  ...
  var matportalAdminDialogApp = {
    cacheElements: function cacheElements() {
      this.cache = {
        $deactivateLink: $('#the-list').find('[data-slug="matportal"] span.deactivate a'),
        $dialogHeader: $('#matportal-deactivate-feedback-dialog-header'),
        $dialogForm: $('#matportal-deactivate-feedback-dialog-form')
      };
    },
    ...
    initModal: function initModal() {
      ...
      self.getModal = function () {
        if (!modal) {
          modal = matportalCommon.dialogsManager.createWidget('lightbox', {
            id: 'matportal-deactivate-feedback-modal',
            ...
            onReady: function onReady() {
              ...
              this.addButton({
                name: 'submit',
                text: matportalAdmin.translate('submit_n_deactivate'),
                callback: self.sendFeedback.bind(self)
              });

              if (!matportalAdmin.config.feedback.is_tracker_opted_in) {
                this.addButton({
                  name: 'skip',
                  text: matportalAdmin.translate('skip_n_deactivate'),
            ...
            onShow: function onShow() {
              var $dialogModal = $('#matportal-deactivate-feedback-modal'),
                  radioSelector = '.matportal-deactivate-feedback-dialog-input';
    ...
    sendFeedback: function sendFeedback() {
      ...
      self.getModal().getElements('submit').text('').addClass('matportal-loading');
