...
var HooksBase = /*#__PURE__*/function (_matportalModules$Mod) {
  (0, _inherits2.default)(HooksBase, _matportalModules$Mod);
  ...
  (0, _createClass2.default)(HooksBase, [{
    ...
    value: function checkInstance(instance) {
      if (instance.getType() !== this.getType()) {
        throw new Error("invalid instance, please use: 'matportal-api/modules/hook-base.js'. ");
      }
    }
    /**
     * Function checkId().
...
var Commands = /*#__PURE__*/function (_matportalModules$Mod) {
  (0, _inherits2.default)(Commands, _matportalModules$Mod);
...
var _default = /*#__PURE__*/function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'matportal-finder__results__category';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-finder__results__category';
    }
  }, {
    key: "getChildView",
    ...
    key: "initialize",
    value: function initialize() {
      this.childViewContainer = '.matportal-finder__results__category__items';
      this.isVisible = true;
    ...
    value: function getTextFilter() {
      return matportalCommon.finder.channel.request('filter:text').trim().toLowerCase();
    }
  }, {
    key: "toggleElement",
    ...
    value: function onRender() {
      this.listenTo(matportalCommon.finder.channel, 'filter:change', this.onFilterChange.bind(this));
    }
  }, {
    key: "onFilterChange",
...
var matportalCommonApp = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(matportalCommonApp, _matportalModules$Vie);

  var _super = (0, _createSuper2.default)(matportalCommonApp);

  function matportalCommonApp() {
    (0, _classCallCheck2.default)(this, matportalCommonApp);
    return _super.apply(this, arguments);
  }

  (0, _createClass2.default)(matportalCommonApp, [{
    ...
    value: function onInit() {
      (0, _get2.default)((0, _getPrototypeOf2.default)(matportalCommonApp.prototype), "onInit", this).call(this);
      this.config = matportalCommonConfig;
      this.setMarionetteTemplateCompiler();
    }
  }]);
  return matportalCommonApp;
}(matportalModules.ViewModule);

window.matportalCommon = new matportalCommonApp();
matportalCommon.initComponents();
...
var Helpers = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Helpers, [{
    ...
    value: function softDeprecated(name, version, replacement) {
      if (matportalCommon.config.isDebug) {
    ...
    value: function consoleWarn() {
      ...
      var style = "font-size: 12px; background-image: url(\"".concat(matportalCommon.config.urls.assets, "images/logo-icon.png\"); background-repeat: no-repeat; background-size: contain;");
    ...
    value: function deprecatedMethod(methodName, version, replacement) {
      ...
      this.softDeprecated('matportalCommon.helpers.deprecatedMethod', '2.8.0', 'matportalCommon.helpers.softDeprecated || matportalCommon.helpers.hardDeprecated');
    }
  }, {
    key: "cloneObject",
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        ajaxParams: {
          type: 'POST',
          url: matportalCommon.config.ajax.url,
          data: {},
          dataType: 'json'
        },
        actionPrefix: 'matportal_'
      };
    }
  }]);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function prepareSend(action, options) {
      ...
      var settings = this.getSettings(),
          ajaxParams = matportalCommon.helpers.cloneObject(settings.ajaxParams);
      options = options || {};
      action = settings.actionPrefix + action;
      jQuery.extend(ajaxParams, options);
      var requestConstants = matportalCommon.helpers.cloneObject(this.requestConstants);
...
var _default = /*#__PURE__*/function (_matportalModules$Mod) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "onInit",
    value: function onInit() {
      this.channel = Backbone.Radio.channel('matportal:finder');
...
var _default = /*#__PURE__*/function (_matportalModules$com) {
  (0, _inherits2.default)(_default, _matportalModules$com);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getLogoOptions() {
      return {
        title: matportalCommon.translate('finder', 'finder')
      };
    }
  }, {
    key: "initialize",
...
var _default = /*#__PURE__*/function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'matportal-finder';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-finder';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        searchInput: '#matportal-finder__search__input'
      };
    }
  }, {
    key: "events",
    ...
    value: function regions() {
      return {
        content: '#matportal-finder__content'
      };
    }
  }, {
    ...
    value: function onSearchInputInput() {
      ...
      if (value) {
        matportalCommon.finder.channel.reply('filter:text', value).trigger('filter:change');
...
var _default = /*#__PURE__*/function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'matportal-finder__results-container';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        noResults: '#matportal-finder__no-results',
        categoryItem: '.matportal-finder__results__item'
      };
    }
  }, {
    key: "events",
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-finder-results-container';
    }
  }, {
    key: "getChildView",
    ...
    value: function initialize() {
      ...
      this.childViewContainer = '#matportal-finder__results';
      this.collection = new Backbone.Collection((0, _values.default)(matportalCommon.finder.getSettings('data')));
    }
  }, {
    key: "activateItem",
    value: function activateItem($item) {
      if (this.$activeItem) {
        this.$activeItem.removeClass('matportal-active');
      }

      $item.addClass('matportal-active');
...
var _default = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return 'matportal-finder__results__item';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-matportal-finder__results__item';
    }
  }]);
  return _default;
}(Marionette.ItemView);
...
var _default = /*#__PURE__*/function (_Category) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), "className", this).call(this) + ' matportal-finder__results__category--dynamic';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        title: '.matportal-finder__results__category__title'
      };
    }
  }, {
    key: "fetchData",
    value: function fetchData() {
      ...
      matportalCommon.ajax.addRequest('finder_get_category_items', {
        data: {
...
var _default = /*#__PURE__*/function (_matportalModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function addPopupPlugin() {
      ...
      jQuery.fn.matportalConnect = function (options) {
        var settings = jQuery.extend({
          ...
          error: function error() {
            matportal.notifications.showToast({
              message: matportal.translate('connect_error')
            });
          }
        }, options);
        this.each(function () {
          ...
          matportalCommon.elements.$window.on('matportal/connect/success/' + callbackId, settings.success).on('matportal/connect/error/' + callbackId, settings.error);
        });
        return this;
      };
    }
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          connectButton: '#matportal-template-library-connect__button'
        }
      };
    }
  }, {
    ...
    value: function applyPopup() {
      this.elements.$connectButton.matportalConnect();
    }
  }, {
    key: "onInit",
    value: function onInit() {
...
var BackwardsCompatibility = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(BackwardsCompatibility, [{
    ...
    value: function ensureTab(namespace, tabSlug) {
        ...
        var Component = /*#__PURE__*/function (_ComponentBase) {
          ...
          (0, _createClass2.default)(Component, [{
            ...
            value: function renderTab(tab) {
              matportal.getPanelView().setPage(page).activateTab(tab);
            }
          }]);
          return Component;
        }(_componentBase.default);
      ...
      if (!component.hasTab(tabSlug) && matportal.config.tabs[tabSlug]) {
        component.addTab(tabSlug, {
          title: matportal.config.tabs[tabSlug]
        });
      }
    }
  }]);
...
var Data = /*#__PURE__*/function (_HooksBase) {
  ...
  (0, _createClass2.default)(Data, [{
    ...
    key: "shouldRun",
    value: function shouldRun(callbacks) {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(Data.prototype), "shouldRun", this).call(this, callbacks) && matportal.documents.getCurrent().history.getActive();
    }
  }, {
    key: "onRun",
    value: function onRun(command, args, event) {
    ...
    value: function handle(event) {
      ...
      var filteredHandlers = handlers.filter(function (handler) {
        if (handler.exclude && -1 !== handler.exclude.indexOf('input')) {
          ...
          if ($target.is(':input, .matportal-input') || $target.closest('[contenteditable="true"]').length) {
            return false;
          }
        }
      ...
      if (1 < filteredHandlers.length && matportalCommon.config.isDebug) {
        matportalCommon.helpers.consoleWarn('Multiple handlers for shortcut.', filteredHandlers, event);
      }
