...
var _default = /*#__PURE__*/function (_matportalModules$Mod) {
  (0, _inherits2.default)(_default, _matportalModules$Mod);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function get(key, options) {
      ...
      var matportalStorage = storage.getItem('matportal');

      if (matportalStorage) {
        matportalStorage = JSON.parse(matportalStorage);
      } else {
        matportalStorage = {};
      }

      if (!matportalStorage.__expiration) {
        matportalStorage.__expiration = {};
      }

      var expiration = matportalStorage.__expiration;
      ...
      expirationToCheck.forEach(function (expirationKey) {
        if (new Date(expiration[expirationKey]) < new Date()) {
          delete matportalStorage[expirationKey];
      ...
      if (entryExpired) {
        this.save(matportalStorage, options.session);
      }

      if (key) {
        return matportalStorage[key];
      }

      return matportalStorage;
    }
  }, {
    key: "set",
    value: function set(key, value, options) {
      options = options || {};
      var matportalStorage = this.get(null, options);
      matportalStorage[key] = value;

      if (options.lifetimeInSeconds) {
        var date = new Date();
        date.setTime(date.getTime() + options.lifetimeInSeconds * 1000);
        matportalStorage.__expiration[key] = date.getTime();
      }
    ...
    value: function save(object, session) {
      ...
      storage.setItem('matportal', (0, _stringify.default)(object));
    }
  }]);
  return _default;
...
var _default = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(_default, _matportalModules$Vie);
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          elements: '.matportal-element',
          nestedDocumentElements: '.matportal .matportal-element'
        },
        classes: {
          editMode: 'matportal-edit-mode'
        }
      };
    }
  }, {
    ...
    value: function getDocumentSettings(setting) {
      ...
      if (this.isEdit) {
        elementSettings = {};
        var settings = matportal.settings.page.model;
        jQuery.each(settings.getActiveControls(), function (controlKey) {
          elementSettings[controlKey] = settings.attributes[controlKey];
        });
      } else {
        elementSettings = this.$element.data('matportal-settings') || {};
      }
    ...
    value: function runElementsHandlers() {
      this.elements.$elements.each(function (index, element) {
        return matportalFrontend.elementsHandler.runReadyTrigger(element);
      });
    }
  }, {
    key: "onInit",
    value: function onInit() {
      ...
      if (this.isEdit) {
        matportal.on('document:loaded', function () {
          matportal.settings.page.model.on('change', _this.onSettingsChange.bind(_this));
        });
      } else {
...
var baseTabs = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(baseTabs, _matportalModules$fro);
  ...
  (0, _createClass2.default)(baseTabs, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          tabTitle: '.matportal-tab-title',
          tabContent: '.matportal-tab-content'
        },
        classes: {
...
var BaseLoader = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(BaseLoader, _matportalModules$Vie);
...
var BackgroundSlideshow = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(BackgroundSlideshow, _matportalModules$fro);
  ...
  (0, _createClass2.default)(BackgroundSlideshow, [{
    ...
    value: function getDefaultSettings() {
      return {
        classes: {
          swiperContainer: 'matportal-background-slideshow swiper-container',
          swiperWrapper: 'swiper-wrapper',
          swiperSlide: 'matportal-background-slideshow__slide swiper-slide',
          swiperSlideInner: 'matportal-background-slideshow__slide__image',
          kenBurns: 'matportal-ken-burns',
          kenBurnsActive: 'matportal-ken-burns--active',
          kenBurnsIn: 'matportal-ken-burns--in',
          kenBurnsOut: 'matportal-ken-burns--out'
        }
      };
    }
  }, {
...
/* global matportalFrontendConfig */
...
var Frontend = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(Frontend, _matportalModules$Vie);
  ...
  function Frontend() {
    ...
    _this.config = matportalFrontendConfig;
    return _this;
  } // TODO: BC since 2.5.0
  ...
  (0, _createClass2.default)(Frontend, [{
    ...
    value: function getPageSettings(settingName) {
      var settingsObject = this.isEditMode() ? matportal.settings.page.model.attributes : this.config.settings.page;
      return this.getItems(settingsObject, settingName);
    }
  }, {
    key: "getGeneralSettings",
    value: function getGeneralSettings(settingName) {
      var settingsObject = this.isEditMode() ? matportal.settings.general.model.attributes : this.config.settings.general;
      return this.getItems(settingsObject, settingName);
    }
  }, {
    ...
    value: function getCurrentDeviceSetting(settings, settingKey) {
      return this.getDeviceSetting(matportalFrontend.getCurrentDeviceMode(), settings, settingKey);
    }
  }, {
    key: "isEditMode",
    ...
    value: function initOnReadyComponents() {
      ...
      this.modules = {
        StretchElement: matportalModules.frontend.tools.StretchElement,
        Masonry: matportalModules.utils.Masonry
      };
      this.elementsHandler = new ElementsHandler(jQuery);

      if (this.isEditMode()) {
        matportal.once('document:loaded', function () {
    ...
    value: function addIeCompatibility() {
      ...
      var msieCss = '<link rel="stylesheet" id="matportal-frontend-css-msie" href="' + this.config.urls.assets + 'css/frontend-msie.min.css?' + this.config.version + '" type="text/css" />';
      this.elements.$body.append(msieCss);
    }
  }, {
    key: "setDeviceModeData",
    value: function setDeviceModeData() {
      this.elements.$body.attr('data-matportal-device-mode', this.getCurrentDeviceMode());
    }
  }, {
    key: "addListenerOnce",
    ...
    value: function waypoint($element, callback, options) {
      ...
      return $element.matportalWaypoint(correctCallback, options);
    }
  }, {
    ...
    value: function init() {
      ...
      this.elements.$window.trigger('matportal/frontend/init');
    ...
    get: function get() {
      if (this.isEditMode()) {
        parent.matportalCommon.helpers.hardDeprecated('matportalFrontend.Module', '2.5.0', 'matportalModules.frontend.handlers.Base');
      }

      return matportalModules.frontend.handlers.Base;
    }
  }]);
  return Frontend;
}(matportalModules.ViewModule);

window.matportalFrontend = new Frontend();

if (!matportalFrontend.isEditMode()) {
  jQuery(function () {
    return matportalFrontend.init();
  });
}
...
var _default = /*#__PURE__*/function (_matportalModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function initDocumentClasses() {
      ...
      matportalFrontend.hooks.doAction('matportal/frontend/documents-manager/init-classes', this);
    }
  }, {
    ...
    value: function attachDocumentClass($document) {
      var documentData = $document.data(),
          documentID = documentData.matportalId,
          documentType = documentData.matportalType,
...
var _default = /*#__PURE__*/function (_matportalModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          links: 'a[href^="%23matportal-action"], a[href^="#matportal-action"]'
        }
      };
    }
  }, {
    ...
    value: function initActions() {
      this.actions = {
        lightbox: function lightbox(settings) {
          if (settings.id) {
            matportalFrontend.utils.lightbox.openSlideshow(settings.id, settings.url);
          } else {
            matportalFrontend.utils.lightbox.showModal(settings);
          }
        }
      };
    }
    ...
    value: function createActionHash(action, settings) {
      ...
      return encodeURIComponent("#matportal-action:action=".concat(action, "&settings=").concat(btoa((0, _stringify.default)(settings))));
    }
  }, {
    key: "onInit",
    value: function onInit() {
...
var Swiper = /*#__PURE__*/function () {
  function Swiper(container, config) {
    ...
    if (this.config.breakpoints && this.config.handlematportalBreakpoints) {
      this.adjustConfig();
    }

    return new originalSwiper(container, this.config);
  } // Backwards compatibility for matportal Pro <2.9.0 (old Swiper version - <5.0.0)
  ...
  (0, _createClass2.default)(Swiper, [{
    ...
    value: function adjustConfig() {
      ...
      var matportalBreakpoints = matportalFrontend.config.breakpoints,
          matportalBreakpointValues = (0, _values.default)(matportalBreakpoints);
      (0, _keys.default)(this.config.breakpoints).forEach(function (configBPKey) {
        var configBPKeyInt = (0, _parseInt2.default)(configBPKey);
        var breakpointToUpdate; // The `configBPKeyInt + 1` is a BC Fix for matportal Pro Carousels from 2.8.0-2.8.3 used with matportal >= 2.9.0

        if (configBPKeyInt === matportalBreakpoints.md || configBPKeyInt + 1 === matportalBreakpoints.md) {
          // This handles the mobile breakpoint. matportal's default sm breakpoint is never actually used,
          // so the mobile breakpoint (md) needs to be handled separately and set to the 0 breakpoint (xs)
          breakpointToUpdate = matportalBreakpoints.xs;
        } else {
          // Find the index of the current config breakpoint in the matportal Breakpoints array
          var currentBPIndexInmatportalBPs = matportalBreakpointValues.findIndex(function (matportalBP) {
            // BC Fix for matportal Pro Carousels from 2.8.0-2.8.3 used with matportal >= 2.9.0
            return configBPKeyInt === matportalBP || configBPKeyInt + 1 === matportalBP;
          }); // For all other Swiper config breakpoints, move them one breakpoint down on the breakpoint list,
          // according to the array of matportal's global breakpoints

          breakpointToUpdate = matportalBreakpointValues[currentBPIndexInmatportalBPs - 1];
        }
...
module.exports = function ($) {
  ...
  var addGlobalHandlers = function addGlobalHandlers() {
    matportalFrontend.hooks.addAction('frontend/element_ready/global', _global.default);
  };

  var addElementsHandlers = function addElementsHandlers() {
    $.each(handlers, function (elementName, funcCallback) {
      matportalFrontend.hooks.addAction('frontend/element_ready/' + elementName, funcCallback);
    });
  };
  ...
  this.runReadyTrigger = function (scope) {
    ...
    matportalFrontend.hooks.doAction('frontend/element_ready/global', $scope, $);
    matportalFrontend.hooks.doAction('frontend/element_ready/' + elementType, $scope, $);

    if ('widget' === elementType) {
      matportalFrontend.hooks.doAction('frontend/element_ready/' + $scope.attr('data-widget_type'), $scope, $);
    }
  };
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(_baseTabs.default, {
    $element: $scope,
    showTabFn: 'slideDown',
    hideTabFn: 'slideUp'
  });
...
var Alert = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(Alert, _matportalModules$fro);
  ...
  (0, _createClass2.default)(Alert, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          dismissButton: '.matportal-alert-dismiss'
        }
      };
    }
  }, {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(Alert, {
    $element: $scope
  });
};
...
var Counter = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(Counter, _matportalModules$fro);
  ...
  (0, _createClass2.default)(Counter, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          counterNumber: '.matportal-counter-number'
        }
      };
    }
  }, {
    ...
    value: function onInit() {
      ...
      matportalFrontend.waypoint(this.elements.$counterNumber, function () {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(Counter, {
    $element: $scope
  });
};
...
var Progress = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(Progress, _matportalModules$fro);
  ...
  (0, _createClass2.default)(Progress, [{
    ...
    value: function onInit() {
      ...
      matportalFrontend.waypoint(this.elements.$progressNumber, function () {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(Progress, {
    $element: $scope
  });
};
...
var VideoModule = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(VideoModule, _matportalModules$fro);
  ...
  (0, _createClass2.default)(VideoModule, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          imageOverlay: '.matportal-custom-embed-image-overlay',
          video: '.matportal-video',
          videoIframe: '.matportal-video-iframe'
        }
      };
    }
  }, {
    ...
    value: function getLightBox() {
      return matportalFrontend.utils.lightbox;
    }
  }, {
    key: "handleVideo",
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(VideoModule, {
    $element: $scope
  });
};
...
var ImageCarouselHandler = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(ImageCarouselHandler, _matportalModules$fro);
  ...
  (0, _createClass2.default)(ImageCarouselHandler, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          carousel: '.matportal-image-carousel-wrapper',
    ...
    value: function getSwiperSettings() {
      var elementSettings = this.getElementSettings(),
          ...
          matportalBreakpoints = matportalFrontend.config.breakpoints;
      var swiperOptions = {
      ...
      swiperOptions.breakpoints[matportalBreakpoints.md] = {
        slidesPerView: +elementSettings.slides_to_show_mobile || 1,
        slidesPerGroup: +elementSettings.slides_to_scroll_mobile || 1
      };
      swiperOptions.breakpoints[matportalBreakpoints.lg] = {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(ImageCarouselHandler, {
    $element: $scope
  });
};
...
var TextEditor = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(TextEditor, _matportalModules$fro);
  ...
  (0, _createClass2.default)(TextEditor, [{
    ...
    value: function getDefaultSettings() {
      return {
        ...
        classes: {
          dropCap: 'matportal-drop-cap',
          dropCapLetter: 'matportal-drop-cap-letter'
        }
      };
    }
  }, {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(TextEditor, {
    $element: $scope
  });
};
...
var _default = function _default($scope) {
  if (matportalFrontend.isEditMode() || $scope.hasClass('matportal-section-stretched')) {
    matportalFrontend.elementsHandler.addHandler(_stretchedSection.default, {
      $element: $scope
    });
  }

  if (matportalFrontend.isEditMode()) {
    matportalFrontend.elementsHandler.addHandler(_shapes.default, {
      $element: $scope
    });
    matportalFrontend.elementsHandler.addHandler(_handlesPosition.default, {
      $element: $scope
    });
  }

  matportalFrontend.elementsHandler.addHandler(_backgroundVideo.default, {
    $element: $scope
  });
  matportalFrontend.elementsHandler.addHandler(_backgroundSlideshow.default, {
    $element: $scope
  });
};
...
var BackgroundVideo = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(BackgroundVideo, _matportalModules$fro);
  ...
  (0, _createClass2.default)(BackgroundVideo, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          backgroundVideoContainer: '.matportal-background-video-container',
          backgroundVideoEmbed: '.matportal-background-video-embed',
          backgroundVideoHosted: '.matportal-background-video-hosted'
        }
      };
    }
  }, {
    ...
    value: function prepareVimeoVideo(Vimeo, videoId) {
      ...
      this.player.ready().then(function () {
        jQuery(_this2.player.element).addClass('matportal-background-video-embed');
    ...
    value: function prepareYTVideo(YT, videoID) {
      ...
      $backgroundVideoContainer.addClass('matportal-loading matportal-invisible');
      this.player = new YT.Player(this.elements.$backgroundVideoEmbed[0], {
        ...
        events: {
          ...
          onStateChange: function onStateChange(event) {
            switch (event.data) {
              case startStateCode:
                $backgroundVideoContainer.removeClass('matportal-invisible matportal-loading');
                break;
    ...
    value: function activate() {
      ...
      if (-1 !== videoLink.indexOf('vimeo.com')) {
        ...
        this.apiProvider = matportalFrontend.utils.vimeo;
      } else if (videoLink.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/)) {
        this.videoType = 'youtube';
        this.apiProvider = matportalFrontend.utils.youtube;
      }
      ...
      matportalFrontend.elements.$window.on('resize', this.changeVideoSize);
    }
  }, {
    key: "deactivate",
    value: function deactivate() {
      ...
      matportalFrontend.elements.$window.off('resize', this.changeVideoSize);
    }
  }, {
    key: "run",
    value: function run() {
      ...
      if (!elementSettings.background_play_on_mobile && 'mobile' === matportalFrontend.getCurrentDeviceMode()) {
        return;
      }
...
var HandlesPosition = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(HandlesPosition, _matportalModules$fro);
  ...
  (0, _createClass2.default)(HandlesPosition, [{
    ...
    value: function isFirstSection() {
      return this.$element.is('.matportal-edit-mode .matportal-top-section:first');
    }
  }, {
    ...
    value: function getOffset() {
      if ('body' === matportal.config.document.container) {
        return this.$element.offset().top;
      }

      var $container = jQuery(matportal.config.document.container);
      return this.$element.offset().top - $container.offset().top;
    }
  }, {
    key: "setHandlesPosition",
    value: function setHandlesPosition() {
      var document = matportal.documents.getCurrent();
      ...
      var offset = isOverflowHidden ? 0 : this.getOffset(),
          $handlesElement = this.$element.find('> .matportal-element-overlay > .matportal-editor-section-settings'),
          insideHandleClass = 'matportal-section--handles-inside';
...
var StretchedSection = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(StretchedSection, _matportalModules$fro);
  ...
  (0, _createClass2.default)(StretchedSection, [{
    ...
    value: function bindEvents() {
      ...
      matportalFrontend.addListenerOnce(handlerID, 'resize', this.stretch);
      matportalFrontend.addListenerOnce(handlerID, 'sticky:stick', this.stretch, this.$element);
      matportalFrontend.addListenerOnce(handlerID, 'sticky:unstick', this.stretch, this.$element);
    }
  }, {
    key: "unbindEvents",
    value: function unbindEvents() {
      matportalFrontend.removeListeners(this.getUniqueHandlerID(), 'resize', this.stretch);
    }
  }, {
    key: "initStretch",
    value: function initStretch() {
      this.stretch = this.stretch.bind(this);
      this.stretchElement = new matportalModules.frontend.tools.StretchElement({
    ...
    value: function getStretchContainer() {
      return matportalFrontend.getGeneralSettings('matportal_stretched_section_container') || window;
    }
  }, {
    key: "stretch",
    ...
    value: function onGeneralSettingsChange(changed) {
      if ('matportal_stretched_section_container' in changed) {
...
var Shapes = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(Shapes, _matportalModules$fro);
  ...
  (0, _createClass2.default)(Shapes, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          container: '> .matportal-shape-%s'
        },
        svgURL: matportalFrontend.config.urls.assets + 'shapes/'
      };
    }
  }, {
    key: "getDefaultElements",
    ...
    value: function getSvgURL(shapeType, fileName) {
      ...
      if (matportal.config.additional_shapes && shapeType in matportal.config.additional_shapes) {
        svgURL = matportal.config.additional_shapes[shapeType];
...
var GlobalHandler = /*#__PURE__*/function (_matportalModules$fro) {
  (0, _inherits2.default)(GlobalHandler, _matportalModules$fro);
  ...
  (0, _createClass2.default)(GlobalHandler, [{
    ...
    value: function animate() {
      ...
      if ('none' === animation) {
        $element.removeClass('matportal-invisible');
        return;
      }
      ...
      setTimeout(function () {
        $element.removeClass('matportal-invisible').addClass('animated ' + animation);
      }, animationDelay);
    }
  }, {
    key: "getAnimation",
    ...
    value: function onInit() {
      ...
      if (this.getAnimation()) {
        matportalFrontend.waypoint(this.$element, function () {
...
var _default = function _default($scope) {
  matportalFrontend.elementsHandler.addHandler(GlobalHandler, {
    $element: $scope
  });
};
...
module.exports = matportalModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      scrollDuration: 500,
      selectors: {
        links: 'a[href*="#"]',
        targets: '.matportal-element, .matportal-menu-anchor',
  ...
  bindEvents: function bindEvents() {
    matportalFrontend.elements.$document.on('click', this.getSettings('selectors.links'), this.handleAnchorLinks);
  },
  handleAnchorLinks: function handleAnchorLinks(event) {
    ...
    var scrollTop = $anchor.offset().top,
        ...
        $activeStickies = jQuery('.matportal-section.matportal-sticky--active:visible'),
        maxStickyHeight = 0;
    ...
    event.preventDefault();
    scrollTop = matportalFrontend.hooks.applyFilters('frontend/handlers/menu_anchor/scroll_top_distance', scrollTop);
...
module.exports = matportalModules.ViewModule.extend({
  ...
  getDefaultSettings: function getDefaultSettings() {
    return {
      classes: {
        aspectRatio: 'matportal-aspect-ratio-%s',
        item: 'matportal-lightbox-item',
        image: 'matportal-lightbox-image',
        videoContainer: 'matportal-video-container',
        videoWrapper: 'matportal-fit-aspect-ratio',
        playButton: 'matportal-custom-embed-play',
        playButtonIcon: 'fa',
        playing: 'matportal-playing',
        hidden: 'matportal-hidden',
        invisible: 'matportal-invisible',
        preventClose: 'matportal-lightbox-prevent-close',
        slideshow: {
          container: 'swiper-container',
          slidesWrapper: 'swiper-wrapper',
          prevButton: 'matportal-swiper-button matportal-swiper-button-prev',
          nextButton: 'matportal-swiper-button matportal-swiper-button-next',
          prevButtonIcon: 'eicon-chevron-left',
          nextButtonIcon: 'eicon-chevron-right',
          slide: 'swiper-slide',
          header: 'matportal-slideshow__header',
          footer: 'matportal-slideshow__footer',
          title: 'matportal-slideshow__title',
          description: 'matportal-slideshow__description',
          counter: 'matportal-slideshow__counter',
          iconExpand: 'eicon-frame-expand',
          iconShrink: 'eicon-frame-minimize',
          iconZoomIn: 'eicon-zoom-in-bold',
          iconZoomOut: 'eicon-zoom-out-bold',
          iconShare: 'eicon-share-arrow',
          shareMenu: 'matportal-slideshow__share-menu',
          shareLinks: 'matportal-slideshow__share-links',
          hideUiVisibility: 'matportal-slideshow--ui-hidden',
          shareMode: 'matportal-slideshow--share-mode',
          fullscreenMode: 'matportal-slideshow--fullscreen-mode',
          zoomMode: 'matportal-slideshow--zoom-mode'
        }
      },
      selectors: {
        links: 'a, [data-matportal-lightbox]',
        slideshow: {
  ...
  initModal: function initModal() {
    var modal = module.exports.modal = matportalFrontend.getDialogsManager().createWidget('lightbox', {
      className: 'matportal-lightbox',
      closeButton: true,
  ...
  setVideoContent: function setVideoContent(options) {
    ...
    modal.onHide = function () {
      onHideMethod();
      modal.getElements('message').removeClass('matportal-fit-aspect-ratio');
    };
  },
  getShareLinks: function getShareLinks() {
    var _this = this;

    var i18n = matportalFrontend.config.i18n,
        socialNetworks = {
      ...
      class: classes.slideshow.shareLinks
        ...
        $image = $activeSlide.find('.matportal-lightbox-image'),
        videoUrl = $activeSlide.data('matportal-slideshow-video');
    var itemUrl;
  ...
  createShareLink: function createShareLink(networkName, itemUrl) {
    ...
    if ('pinterest' === networkName) {
      ...
      var hash = matportalFrontend.utils.urlActions.createActionHash('lightbox', {
        id: this.id,
        url: itemUrl
      });
  ...
  getSlideshowHeader: function getSlideshowHeader() {
    var $ = jQuery,
        showCounter = 'yes' === matportalFrontend.getGeneralSettings('matportal_lightbox_enable_counter'),
        showFullscreen = 'yes' === matportalFrontend.getGeneralSettings('matportal_lightbox_enable_fullscreen'),
        showZoom = 'yes' === matportalFrontend.getGeneralSettings('matportal_lightbox_enable_zoom'),
        showShare = 'yes' === matportalFrontend.getGeneralSettings('matportal_lightbox_enable_share'),
        classes = this.getSettings('classes'),
  ...
  setSlideshowContent: function setSlideshowContent(options) {
    ...
    var $ = jQuery,
        ...
        hasTitle = '' !== matportalFrontend.getGeneralSettings('matportal_lightbox_title_src'),
        hasDescription = '' !== matportalFrontend.getGeneralSettings('matportal_lightbox_description_src'),
    ...
    options.slides.forEach(function (slide) {
      ...
      if (slide.video) {
        $slide.attr('data-matportal-slideshow-video', slide.video);
        var $playIcon = $('<div>', {
  ...
  playSlideVideo: function playSlideVideo() {
    ...
    if (-1 !== videoURL.indexOf('vimeo.com')) {
      videoType = 'vimeo';
      apiProvider = matportalFrontend.utils.vimeo;
    } else if (videoURL.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/)) {
      videoType = 'youtube';
      apiProvider = matportalFrontend.utils.youtube;
    }
  ...
  prepareYTVideo: function prepareYTVideo(YT, videoID, $videoContainer, $videoWrapper, $playIcon) {
    ...
    $videoContainer.addClass('matportal-loading' + ' ' + classes.invisible);
      ...
      events: {
        ...
        onStateChange: function onStateChange(event) {
          if (event.data === startStateCode) {
            $videoContainer.removeClass('matportal-loading' + ' ' + classes.invisible);
          }
        }
      },
      playerVars: {
  ...
  setEntranceAnimation: function setEntranceAnimation(animation) {
    animation = animation || matportalFrontend.getCurrentDeviceSetting(this.getSettings('modalOptions'), 'entranceAnimation');
  ...
  isLightboxLink: function isLightboxLink(element) {
    ...
    var generalOpenInLightbox = matportalFrontend.getGeneralSettings('matportal_global_image_lightbox'),
        currentLinkOpenInLightbox = element.dataset.matportalOpenLightbox;
  ...
  openSlideshow: function openSlideshow(slideshowID, initialSlideURL) {
    var $allSlideshowLinks = jQuery(this.getSettings('selectors.links')).filter(function (index, element) {
      ...
      return slideshowID === element.dataset.matportalLightboxSlideshow && !$element.parent('.swiper-slide-duplicate').length && !$element.parents('.slick-cloned').length;
    });
    var slides = [];
    var initialSlideIndex = 0;
    $allSlideshowLinks.each(function () {
      var slideVideo = this.dataset.matportalLightboxVideo;
      var slideIndex = this.dataset.matportalLightboxIndex;
      ...
      var slideData = {
        image: this.href,
        index: slideIndex,
        title: this.dataset.matportalLightboxTitle,
        description: this.dataset.matportalLightboxDescription
      };
    ...
    this.showModal({
      ...
      id: slideshowID,
      modalOptions: {
        id: 'matportal-lightbox-slideshow-' + slideshowID
      },
      slideshow: {
        slides: slides,
        swiper: {
  ...
  openLink: function openLink(event) {
    var element = event.currentTarget,
        ...
        editMode = matportalFrontend.isEditMode(),
        isClickInsidematportal = !!$target.closest('.matportal-edit-area').length;

    if (!this.isLightboxLink(element)) {
      if (editMode && isClickInsidematportal) {
        event.preventDefault();
      }
    ...
    if (editMode && !matportal.getPreferences('lightbox_in_editor')) {
      return;
    }

    var lightboxData = {};

    if (element.dataset.matportalLightbox) {
      lightboxData = JSON.parse(element.dataset.matportalLightbox);
    }
    ...
    if (!element.dataset.matportalLightboxSlideshow) {
      var slideshowID = 'single-img';
      this.showModal({
        type: 'image',
        id: slideshowID,
        url: element.href,
        title: element.dataset.matportalLightboxTitle,
        description: element.dataset.matportalLightboxDescription,
        modalOptions: {
          id: 'matportal-lightbox-slideshow-' + slideshowID
        }
      });
    ...
    this.openSlideshow(element.dataset.matportalLightboxSlideshow, element.href);
  },
  bindEvents: function bindEvents() {
    matportalFrontend.elements.$document.on('click', this.getSettings('selectors.links'), this.openLink);
  },
