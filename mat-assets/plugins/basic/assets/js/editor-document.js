  ...
  (0, _createClass2.default)(CommandBase, [{
    ...
    value: function requireContainer() {
      ...
      containers.forEach(function (container) {
        _this2.requireArgumentInstance('container', matportalModules.editor.Container, {
          container: container
        });
      });
    }
    ...
    value: function apply() {
      var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      // eslint-disable-line no-unused-vars
      matportalModules.ForceMethodImplementation();
    }
    /**
     * Function run().
     *
    ...
    value: function onCatchApply(e) {
      ...
      matportalCommon.helpers.consoleError(e);
...
var ComponentBase = /*#__PURE__*/function (_matportalModules$Mod) {
  (0, _inherits2.default)(ComponentBase, _matportalModules$Mod);
  ...
  (0, _createClass2.default)(ComponentBase, [{
    ...
    value: function activateTab(tab) {
      ...
      this.currentTab = tab;
      this.renderTab(tab);
      jQuery(this.getTabsWrapperSelector() + ' .matportal-component-tab').off('click').on('click', function (event) {
        $e.route(_this4.getTabRoute(event.currentTarget.dataset.tab));
      }).removeClass('matportal-active').filter('[data-tab="' + tab + '"]').addClass('matportal-active');
    }
  }, {
    ...
    value: function toggleRouteClass(route, state) {
      matportalCommon.elements.$body.toggleClass(this.getBodyClass(route), state);
    }
  }, {
    key: "toggleHistoryClass",
    value: function toggleHistoryClass() {
      matportalCommon.elements.$body.toggleClass('e-routes-has-history', !!$e.routes.getHistory(this.getRootContainer()).length);
    }
  }]);
  return ComponentBase;
}(matportalModules.Module);
...
var History = /*#__PURE__*/function (_CommandBase) {
  ...
  (0, _createClass2.default)(History, [{
     ...
     *
     * Return `matportal.documents.getCurrent().history.getActive()`.
     *
     * @returns {boolean}
     */
...
var Helper = /*#__PURE__*/function (_BackwardsCompatibili) {
  ...
  (0, _createClass2.default)(Helper, null, [{
    ...
    value: function isValidChild(childModel, parentModel) {
      ...
      var childTypes = matportal.helpers.getElementChildType(parentElType);
    ...
    value: function isPasteEnabled(targetContainer) {
      var storage = matportalCommon.storage.get('clipboard'); // No storage? no paste.
...
var SectionView = BaseElementView.extend({
  childViewContainer: '> .matportal-container > .matportal-row',
  template: Marionette.TemplateCache.get('#tmpl-matportal-section-content'),
  addSectionView: null,
  _checkIsFull: function _checkIsFull() {
    this.toggleSectionIsFull();
    matportalCommon.helpers.softDeprecated('_checkIsFull', '2.9.0', 'toggleSectionIsFull()');
  },
  toggleSectionIsFull: function toggleSectionIsFull() {
    this.$el.toggleClass('matportal-section-filled', this.isCollectionFilled());
  },
  ...
  className: function className() {
    ...
    return classes + ' matportal-section matportal-' + type + '-section';
  },
  ...
  behaviors: function behaviors() {
    ...
    return matportal.hooks.applyFilters('elements/section/behaviors', behaviors, this);
  },
  ...
  getEditButtons: function getEditButtons() {
    var elementData = matportal.getElementData(this.model),
        editTools = {};

    if (!this.isInner()) {
      editTools.add = {
        title: matportal.translate('add_element', [elementData.title]),
        icon: 'plus'
      };
    }

    editTools.edit = {
      title: matportal.translate('edit_element', [elementData.title]),
      icon: 'handle'
    };

    if (matportal.getPreferences('edit_buttons')) {
      editTools.duplicate = {
        title: matportal.translate('duplicate_element', [elementData.title]),
        icon: 'clone'
      };
    }

    editTools.remove = {
      title: matportal.translate('delete_element', [elementData.title]),
      icon: 'close'
    };
    return editTools;
  },
  getContextMenuGroups: function getContextMenuGroups() {
    ...
    groups.splice(transferGroupIndex + 1, 0, {
      ...
      actions: [{
        name: 'save',
        title: matportal.translate('save_as_block'),
  ...
  getSortableOptions: function getSortableOptions() {
    var sectionConnectClass = this.isInner() ? '.matportal-inner-section' : '.matportal-top-section';
    return {
      connectWith: sectionConnectClass + ' > .matportal-container > .matportal-row',
      handle: '> .matportal-element-overlay .matportal-editor-element-edit',
      items: '> .matportal-column',
  ...
  setStructure: function setStructure(structure) {
    ...
    var parsedStructure = matportal.presetsFactory.getParsedStructure(structure);
  ...
  adjustColumns: function adjustColumns() {
    var preset = matportal.presetsFactory.getPresetByStructure(this.getStructure());
  ...
  showChildrenPercentsTooltip: function showChildrenPercentsTooltip(columnView, nextColumnView) {
    ...
    columnView.ui.percentsTooltip.attr('data-side', matportalCommon.config.isRTL ? 'right' : 'left');
    nextColumnView.ui.percentsTooltip.show();
    nextColumnView.ui.percentsTooltip.attr('data-side', matportalCommon.config.isRTL ? 'left' : 'right');
  },
  ...
  onChildviewRequestResizeStart: function onChildviewRequestResizeStart(columnView) {
    ...
    matportal.helpers.disableElementEvents($iframes);
  },
  onChildviewRequestResizeStop: function onChildviewRequestResizeStop(columnView) {
    ...
    var $iframes = columnView.$el.find('iframe').add(nextColumnView.$el.find('iframe'));
    matportal.helpers.enableElementEvents($iframes);
  },
...
module.exports = Marionette.Behavior.extend({
  ...
  initContextMenu: function initContextMenu() {
    ...
    contextMenuGroups.splice(afterGroupIndex, 0, {
      ...
      actions: [{
        name: 'navigator',
        title: matportal.translate('navigator'),
  ...
  onContextMenu: function onContextMenu(event) {
    ...
    matportal.channels.editor.reply('contextMenu:targetView', this.view);
  },
  ...
  onContextMenuHide: function onContextMenuHide() {
    matportal.channels.editor.reply('contextMenu:targetView', null);
  },
  onDestroy: function onDestroy() {
    if (this.contextMenu) {
...
var AddSectionBase = /*#__PURE__*/function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(AddSectionBase, [{
    ...
    value: function template() {
      return Marionette.TemplateCache.get('#tmpl-matportal-add-section');
    }
  }, {
    key: "attributes",
    ...
    value: function ui() {
      return {
        addNewSection: '.matportal-add-new-section',
        closeButton: '.matportal-add-section-close',
        addSectionButton: '.matportal-add-section-button',
        addTemplateButton: '.matportal-add-template-button',
        selectPreset: '.matportal-select-preset',
        presets: '.matportal-preset'
      };
    }
  }, {
    key: "events",
    ...
    value: function className() {
      return 'matportal-add-section matportal-visible-desktop';
    }
  }, {
    key: "setView",
    ...
    value: function getContextMenuGroups() {
      ...
      var hasContent = function hasContent() {
        return matportal.elements.length > 0;
      };
      ...
      return [{
        ...
        actions: [{
          name: 'paste',
          title: matportal.translate('paste'),
          isEnabled: function isEnabled() {
            return _helper.default.isPasteEnabled(matportal.getPreviewContainer());
          },
          callback: function callback() {
            return $e.run('document/ui/paste', {
              container: matportal.getPreviewContainer(),
              options: {
        ...
        actions: [{
          ...
          title: matportal.translate('copy_all_content'),
          ...
          title: matportal.translate('delete_all_content'),
          isEnabled: hasContent,
          callback: function callback() {
    ...
    value: function onRender() {
      this.$el.html5Droppable({
        axis: ['vertical'],
        groups: ['matportal-element'],
        placeholder: false,
        currentElementClass: 'matportal-html5dnd-current-element',
        hasDraggingOnChildClass: 'matportal-dragging-on-child',
    ...
    value: function onPresetSelected(event) {
      ...
      var selectedStructure = event.currentTarget.dataset.structure,
          parsedStructure = matportal.presetsFactory.getParsedStructure(selectedStructure);
    ...
    value: function onDropping() {
      if (matportal.helpers.maybeDisableWidget()) {
        return;
      }

      var selectedElement = matportal.channels.panelElements.request('element:selected'),
          historyId = $e.internal('document/history/start-log', {
        type: 'add',
        title: matportal.helpers.getModelLabel(selectedElement.model)
      }),
...
BaseElementView = BaseContainer.extend({
  ...
  renderAttributes: {},
  className: function className() {
    var classes = 'matportal-element matportal-element-edit-mode ' + this.getElementUniqueID();

    if (this.toggleEditTools) {
      classes += ' matportal-element--toggle-edit-tools';
    }
  ...
  ui: function ui() {
    return {
      tools: '> .matportal-element-overlay > .matportal-editor-element-settings',
      editButton: '> .matportal-element-overlay .matportal-editor-element-edit',
      duplicateButton: '> .matportal-element-overlay .matportal-editor-element-duplicate',
      addButton: '> .matportal-element-overlay .matportal-editor-element-add',
      removeButton: '> .matportal-element-overlay .matportal-editor-element-remove'
    };
  },
  behaviors: function behaviors() {
    var groups = matportal.hooks.applyFilters('elements/' + this.options.model.get('elType') + '/contextMenuGroups', this.getContextMenuGroups(), this);
    var behaviors = {
      contextMenu: {
        behaviorClass: __webpack_require__(212),
        groups: groups
    ...
    return matportal.hooks.applyFilters('elements/base/behaviors', behaviors, this);
  },
  ...
  getChildType: function getChildType() {
    return matportal.helpers.getElementChildType(this.getElementType());
  },
  getChildView: function getChildView(model) {
    ...
    if ('section' === elType) {
      ...
      ChildView = matportal.modules.elements.views.Widget;
    }

    return matportal.hooks.applyFilters('element/view', ChildView, model, this);
  },
  ...
  getContainer: function getContainer() {
    ...
    if (!this.container) {
      ...
      this.container = new matportalModules.editor.Container({
        ...
        children: [],
        label: matportal.helpers.getModelLabel(this.model),
  ...
  getContextMenuGroups: function getContextMenuGroups() {
    ...
    return [{
      ...
      actions: [{
        name: 'edit',
        icon: 'eicon-edit',
        title: matportal.translate('edit_element', [this.options.model.getTitle()]),
        callback: function callback() {
        ...
        name: 'duplicate',
        icon: 'eicon-clone',
        title: matportal.translate('duplicate'),
      ...
      actions: [{
        name: 'copy',
        title: matportal.translate('copy'),
        ...
        name: 'pasteStyle',
        title: matportal.translate('paste_style'),
        shortcut: controlSign + '+⇧+V',
        isEnabled: function isEnabled() {
          return !!matportalCommon.storage.get('clipboard');
        },
        callback: function callback() {
        ...
        name: 'resetStyle',
        title: matportal.translate('reset_style'),
        callback: function callback() {
      ...
      actions: [{
        name: 'delete',
        icon: 'eicon-trash',
        title: matportal.translate('delete'),
        shortcut: '⌦',
        callback: function callback() {
  ...
  initialize: function initialize() {
    ...
    if (this.collection && this.onCollectionChanged) {
      matportalCommon.helpers.softDeprecated('onCollectionChanged', '2.8.0', '$e.hooks');
      this.listenTo(this.collection, 'add remove reset', this.onCollectionChanged, this);
    }

    if (this.onSettingsChanged) {
      matportalCommon.helpers.softDeprecated('onSettingsChanged', '2.8.0', '$e.hooks');
  ...
  getHandlesOverlay: function getHandlesOverlay() {
    var $handlesOverlay = jQuery('<div>', {
      class: 'matportal-element-overlay'
    }),
        $overlayList = jQuery('<ul>', {
      class: "matportal-editor-element-settings matportal-editor-".concat(this.getElementType(), "-settings")
    });
    jQuery.each(this.getEditButtons(), function (toolName, tool) {
      var $item = jQuery('<li>', {
        class: "matportal-editor-element-setting matportal-editor-element-".concat(toolName),
        title: tool.title
      }),
          $icon = jQuery('<i>', {
  ...
  startTransport: function startTransport() {
    matportalCommon.helpers.softDeprecated('element.startTransport', '2.8.0', "$e.run( 'document/elements/copy' )");
    $e.run('document/elements/copy', {
      container: this.getContainer()
    });
  },
  copy: function copy() {
    matportalCommon.helpers.softDeprecated('element.copy', '2.8.0', "$e.run( 'document/elements/copy' )");
    $e.run('document/elements/copy', {
      container: this.getContainer()
    });
  },
  cut: function cut() {
    matportalCommon.helpers.softDeprecated('element.cut', '2.8.0');
  },
  paste: function paste() {
    matportalCommon.helpers.softDeprecated('element.paste', '2.8.0', "$e.run( 'document/elements/paste' )");
  ...
  duplicate: function duplicate() {
    matportalCommon.helpers.softDeprecated('element.duplicate', '2.8.0', "$e.run( 'document/elements/duplicate' )");
    $e.run('document/elements/duplicate', {
      container: this.getContainer()
    });
  },
  pasteStyle: function pasteStyle() {
    matportalCommon.helpers.softDeprecated('element.pasteStyle', '2.8.0', "$e.run( 'document/elements/paste-style' )");
    $e.run('document/elements/paste-style', {
      container: this.getContainer()
    });
  },
  resetStyle: function resetStyle() {
    matportalCommon.helpers.softDeprecated('element.resetStyle', '2.8.0', "$e.run( 'document/elements/reset-style' )");
  ...
  toggleVisibilityClass: function toggleVisibilityClass() {
    this.$el.toggleClass('matportal-edit-hidden', !!this.model.get('hidden'));
  },
  addElementFromPanel: function addElementFromPanel(options) {
    options = options || {};
    var elementView = matportal.channels.panelElements.request('element:selected'),
        model = {
  ...
  enqueueFonts: function enqueueFonts() {
    ...
    jQuery.each(settings.getFontControls(), function (index, control) {
      ...
      matportal.helpers.enqueueFont(fontFamilyName);
    }); // Enqueue Icon Fonts
    ...
    jQuery.each(settings.getIconsControls(), function (index, control) {
      ...
      matportal.helpers.enqueueIconFonts(iconType.library);
    });
  },
  renderStyles: function renderStyles(settings) {
    ...
    this.controlsCSSParser.addStyleRules(settings.getStyleControls(), settings.attributes, this.getEditModel().get('settings').controls, [/{{ID}}/g, /{{WRAPPER}}/g], [this.getID(), '.matportal-' + matportal.config.document.id + ' .matportal-element.' + this.getElementUniqueID()]);
  ...
  renderCustomClasses: function renderCustomClasses() {
    ...
    _.each(classControls, function (control) {
      ...
      var isVisible = matportal.helpers.isActiveControl(control, settings.attributes);
  ...
  runReadyTrigger: function runReadyTrigger() {
    ...
    _.defer(function () {
      matportalFrontend.elementsHandler.runReadyTrigger(self.el);

      if (!matportalFrontend.isEditMode()) {
        return;
      } // In edit mode - handle an external elements that loaded by another elements like shortcode etc.


      self.$el.find('.matportal-element.matportal-' + self.model.get('elType') + ':not(.matportal-element-edit-mode)').each(function () {
        matportalFrontend.elementsHandler.runReadyTrigger(this);
      });
    });
  },
  ...
  getElementUniqueID: function getElementUniqueID() {
    return 'matportal-element-' + this.getID();
  },
  ...
  renderOnChange: function renderOnChange(settings) {
    ...
    if (settings instanceof matportalModules.editor.elements.models.BaseSettings) {
  ...
  getDynamicParsingSettings: function getDynamicParsingSettings() {
    ...
    return {
      onServerRequestStart: function onServerRequestStart() {
        self.$el.addClass('matportal-loading');
      },
      onServerRequestEnd: function onServerRequestEnd() {
        self.render();
        self.$el.removeClass('matportal-loading');
      }
    };
  },
    ...
    if (this.toggleEditTools) {
      ...
      if (this.ui.tools) {
        this.ui.tools.hoverIntent(function () {
          editButton.addClass('matportal-active');
        }, function () {
          editButton.removeClass('matportal-active');
        }, {
          timeout: 500
        });
      }
  ...
  onEditSettingsChanged: function onEditSettingsChanged(changedModel) {
    matportal.channels.editor.trigger('change:editSettings', changedModel, this);
  },
  ...
  onEditRequest: function onEditRequest() {
    ...
    if (options.scrollIntoView) {
      matportal.helpers.scrollToView(this.$el, 200);
    }
  ...
  onMouseDown: function onMouseDown(event) {
    if (jQuery(event.target).closest('.matportal-inline-editing').length) {
      return;
    }

    matportalFrontend.elements.window.document.activeElement.blur();
  },
  onDestroy: function onDestroy() {
    this.controlsCSSParser.removeStyleFromDocument();
    this.getEditModel().get('settings').validators = {};
    matportal.channels.data.trigger('element:destroy', this.model);
  }
});
...
SortableBehavior = Marionette.Behavior.extend({
  ...
  initialize: function initialize() {
    this.listenTo(matportal.channels.dataEditMode, 'switch', this.onEditModeSwitched).listenTo(this.view.options.model, 'request:sort:start', this.startSort).listenTo(this.view.options.model, 'request:sort:update', this.updateSort).listenTo(this.view.options.model, 'request:sort:receive', this.receiveSort);
  },
  ...
  onRender: function onRender() {
    ...
    _.defer(function () {
      self.onEditModeSwitched(matportal.channels.dataEditMode.request('activeMode'));
    });
  },
  onDestroy: function onDestroy() {
    this.deactivate();
  ...
  activate: function activate() {
    ...
    var $childViewContainer = this.getChildViewContainer(),
      ...
      placeholder: 'matportal-sortable-placeholder matportal-' + this.getOption('elChildType') + '-placeholder',
      cursorAt: {
        top: 20,
        left: 25
      },
      helper: this._getSortableHelper.bind(this),
      cancel: 'input, textarea, button, select, option, .matportal-inline-editing, .matportal-tab-title'
    },
  ...
  _getSortableHelper: function _getSortableHelper(event, $item) {
    ...
    return '<div style="height: 84px; width: 125px;" class="matportal-sortable-helper matportal-sortable-helper-' + model.get('elType') + '"><div class="icon"><i class="' + model.getIcon() + '"></i></div><div class="matportal-element-title-wrapper"><div class="title">' + model.getTitle() + '</div></div></div>';
  },
  ...
  startSort: function startSort(event, ui) {
    ...
    matportal.channels.data.reply('dragging:model', model).reply('dragging:view', this.view.children.findByModel(model)).reply('dragging:parent:view', this.view).trigger('drag:start', model).trigger(model.get('elType') + ':drag:start');
  },
  // Move section.
  updateSort: function updateSort(ui) {
    var at = ui.item.parent().children().index(ui.item);
    $e.run('document/elements/move', {
      container: matportal.channels.data.request('dragging:view').getContainer(),
  ...
  receiveSort: function receiveSort(event, ui) {
    ...
    var model = matportal.channels.data.request('dragging:model'),
  ...
  onSortOver: function onSortOver(event) {
    event.stopPropagation();
    var model = matportal.channels.data.request('dragging:model');
    jQuery(event.target).addClass('matportal-draggable-over').attr({
      'data-dragged-element': model.get('elType'),
      'data-dragged-is-inner': model.get('isInner')
    });
    this.$el.addClass('matportal-dragging-on-child');
  },
  onSortOut: function onSortOut(event) {
    event.stopPropagation();
    jQuery(event.target).removeClass('matportal-draggable-over').removeAttr('data-dragged-element data-dragged-is-inner');
    this.$el.removeClass('matportal-dragging-on-child');
  },
...
module.exports = matportalModules.Module.extend({
  errors: [],
...
ControlsCSSParser = matportalModules.ViewModule.extend({
  stylesheet: null,
  getDefaultSettings: function getDefaultSettings() {
    return {
      id: 0,
  ...
  getDefaultElements: function getDefaultElements() {
    var id = "matportal-style-".concat(this.getSettings('id'));
    var $stylesheet = matportal.$previewContents.find("#".concat(id));
  ...
  initStylesheet: function initStylesheet() {
    var breakpoints = matportalFrontend.config.breakpoints;
  ...
  addRepeaterControlsStyleRules: function addRepeaterControlsStyleRules(repeaterValues, repeaterControlsItems, controls, placeholders, replacements) {
    ...
    repeaterControlsItems.forEach(function (item, index) {
      ...
      self.addStyleRules(item, itemModel.attributes, controls, placeholders.concat(['{{CURRENT_ITEM}}']), replacements.concat(['.matportal-repeater-item-' + itemModel.get('_id')]));
    });
  },
  addDynamicControlStyleRules: function addDynamicControlStyleRules(value, control) {
    var self = this;
    matportal.dynamicTags.parseTagsText(value, control.dynamic, function (id, name, settings) {
      var tag = matportal.dynamicTags.createTag(id, name, settings);
      ...
      self.addStyleRules(tagSettingsModel.getStyleControls(), tagSettingsModel.attributes, tagSettingsModel.controls, ['{{WRAPPER}}'], ['#matportal-tag-' + id]);
    });
  },
  addStyleToDocument: function addStyleToDocument() {
    matportal.$previewContents.find('head').append(this.elements.$stylesheetElement);
    var extraCSS = matportal.hooks.applyFilters('editor/style/styleText', '', this.getSettings('context'));
  ...
  onInit: function onInit() {
    matportalModules.ViewModule.prototype.onInit.apply(this, arguments);
    this.initStylesheet();
  }
});
...
ControlsCSSParser.addControlStyleRules = function (stylesheet, control, controls, valueCallback, placeholders, replacements) {
  ...
  _.each(control.selectors, function (cssProperty, selector) {
    ...
    if (!(0, _keys.default)(query).length && control.responsive) {
      query = _.pick(matportalCommon.helpers.cloneObject(control.responsive), ['min', 'max']);
...
ControlsCSSParser.parsePropertyPlaceholder = function (control, value, controls, valueCallback, placeholder, parserControlName) {
  ...
  return matportal.getControlView(control.type).getStyleValue(placeholder, value, control);
};
...
module.exports = Marionette.CompositeView.extend({
  ...
  addElement: function addElement(data, options) {
    ...
    if (data instanceof Backbone.Model) {
      ...
      newItem = {
        id: matportal.helpers.getUniqueID(),
        elType: childTypes[0],
        settings: {},
        elements: []
      };
    ...
    if (options.trigger) {
      matportal.channels.data.trigger(options.trigger.beforeAdd, newItem);
    }
    ...
    if (options.trigger) {
      matportal.channels.data.trigger(options.trigger.afterAdd, newItem);
    }

    if (options.edit && matportal.documents.getCurrent().history.getActive()) {
  ...
  addChildElement: function addChildElement(data, options) {
    matportalCommon.helpers.softDeprecated('addChildElement', '2.8.0', "$e.run( 'document/elements/create' )");
  ...
  cloneItem: function cloneItem(item) {
    ...
    item.id = matportal.helpers.getUniqueID();
  ...
  (0, _createClass2.default)(Base, [{
    ...
    value: function initialize(args) {
      ...
      var _args$document = args.document,
          document = _args$document === void 0 ? matportal.documents.getCurrent() : _args$document;
...
var Base = /*#__PURE__*/function (_CommandInternalBase) {
  ...
  (0, _createClass2.default)(Base, [{
    ...
    value: function initialize(args) {
      ...
      this.history = matportal.documents.getCurrent().history;
    }
  }]);
  return Base;
...
var BackwardsCompatibility = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(BackwardsCompatibility, null, [{
    ...
    value: function findViewRecursive(parent, key, value) {
      ...
      matportalCommon.helpers.softDeprecated('findViewRecursive', '2.9.0', "$e.components.get( 'document' ).utils.findViewRecursive( parent, key, value, multiple )");
      return $e.components.get('document').utils.findViewRecursive(parent, key, value, multiple);
    }
  }, {
    key: "findViewById",
    value: function findViewById(id) {
      matportalCommon.helpers.softDeprecated('findViewById', '2.9.0', "$e.components.get( 'document' ).utils.findViewById( id )");
      return $e.components.get('document').utils.findViewById(id);
    }
  }, {
    key: "findContainerById",
    value: function findContainerById(id) {
      matportalCommon.helpers.softDeprecated('findContainerById', '2.9.0', "$e.components.get( 'document' ).utils.findContainerById( id )");
...
module.exports = matportalModules.Module.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      actions: {},
      classes: {
        list: 'matportal-context-menu-list',
        group: 'matportal-context-menu-list__group',
        groupPrefix: 'matportal-context-menu-list__group-',
        item: 'matportal-context-menu-list__item',
        itemTypePrefix: 'matportal-context-menu-list__item-',
        itemTitle: 'matportal-context-menu-list__item__title',
        itemShortcut: 'matportal-context-menu-list__item__shortcut',
        iconShortcut: 'matportal-context-menu-list__item__icon',
        itemDisabled: 'matportal-context-menu-list__item--disabled',
        divider: 'matportal-context-menu-list__divider',
        hidden: 'matportal-hidden'
      }
    };
  },
  ...
  initModal: function initModal() {
    ...
    this.getModal = function () {
      if (!modal) {
        modal = matportalCommon.dialogsManager.createWidget('simple', {
          className: 'matportal-context-menu',
          message: this.buildActionsList(),
          iframe: matportal.$preview,
          effects: {
            hide: 'hide',
            show: 'show'
          },
          ...
          position: {
            my: (matportalCommon.config.isRTL ? 'right' : 'left') + ' top',
            collision: 'fit'
          }
        });
      }
...
var AddSectionView = /*#__PURE__*/function (_BaseAddSectionView) {
  ...
  (0, _createClass2.default)(AddSectionView, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(AddSectionView.prototype), "className", this).call(this) + ' matportal-add-section-inline';
    }
  }, {
    key: "fadeToDeath",
...
ColumnView = BaseElementView.extend({
  template: Marionette.TemplateCache.get('#tmpl-matportal-column-content'),
  emptyView: ColumnEmptyView,
  childViewContainer: '> .matportal-column-wrap > .matportal-widget-wrap',
  ...
  behaviors: function behaviors() {
    ...
    return matportal.hooks.applyFilters('elements/column/behaviors', behaviors, this);
  },
  className: function className() {
    var classes = BaseElementView.prototype.className.apply(this, arguments),
        type = this.isInner() ? 'inner' : 'top';
    return classes + ' matportal-column matportal-' + type + '-column';
  },
  tagName: function tagName() {
  ...
  ui: function ui() {
    ...
    ui.columnInner = '> .matportal-column-wrap';
    ui.percentsTooltip = '> .matportal-element-overlay .matportal-column-percents-tooltip';
    return ui;
  },
  getEditButtons: function getEditButtons() {
    var elementData = matportal.getElementData(this.model),
  ...
  attachElContent: function attachElContent() {
    ...
    var $tooltip = jQuery('<div>', {
      class: 'matportal-column-percents-tooltip'
    });
    this.$el.children('.matportal-element-overlay').append($tooltip);
  },
  getContextMenuGroups: function getContextMenuGroups() {
    var self = this,
    ...
    groups.splice(generalGroupIndex + 1, 0, {
      ...
      actions: [{
        name: 'addNew',
        icon: 'eicon-plus',
        title: matportal.translate('new_column'),
  ...
  getSortableOptions: function getSortableOptions() {
    return {
      connectWith: '.matportal-widget-wrap',
      items: '> .matportal-element'
    };
  },
  changeChildContainerClasses: function changeChildContainerClasses() {
    var emptyClass = 'matportal-element-empty',
        populatedClass = 'matportal-element-populated';
  ...
  onRender: function onRender() {
    ...
    self.$el.html5Droppable({
      items: ' > .matportal-column-wrap > .matportal-widget-wrap > .matportal-element, >.matportal-column-wrap > .matportal-widget-wrap > .matportal-empty-view > .matportal-first-add',
      axis: ['vertical'],
      groups: ['matportal-element'],
      isDroppingAllowed: self.isDroppingAllowed.bind(self),
      currentElementClass: 'matportal-html5dnd-current-element',
      placeholderClass: 'matportal-sortable-placeholder matportal-widget-placeholder',
      hasDraggingOnChildClass: 'matportal-dragging-on-child',
      onDropping: function onDropping(side, event) {
        ...
        matportal.getPreviewView().onPanelElementDragEnd();
...
module.exports = Marionette.ItemView.extend({
  template: '#tmpl-matportal-empty-preview',
  className: 'matportal-empty-view',
  events: {
    click: 'onClickAdd'
  },
  behaviors: function behaviors() {
...
ResizableBehavior = Marionette.Behavior.extend({
  defaults: {
    handles: matportalCommon.config.isRTL ? 'w' : 'e'
  },
  events: {
  ...
  initialize: function initialize() {
    ...
    this.listenTo(matportal.channels.dataEditMode, 'switch', this.onEditModeSwitched);
  },
...
var getDefaultDebounceDelay = function getDefaultDebounceDelay() {
  ...
  if (matportal.config.document && undefined !== matportal.config.document.debounceDelay) {
    result = matportal.config.document.debounceDelay;
  }
...
var DisableEnable = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(DisableEnable, [{
    ...
    value: function getHistory(args) {
      ...
      var subTitle = matportal.translate('dynamic') + ' ' + _settings.default.getSubTitle(args),
          type = this.type;
  ...
  (0, _createClass2.default)(Copy, [{
    ...
    value: function apply(args) {
      var _args$storageKey = args.storageKey,
          ...
          _args$containers = args.containers,
          containers = _args$containers === void 0 ? [args.container] : _args$containers;
      matportalCommon.storage.set(storageKey, containers.map(function (container) {
...
var CopyAll = /*#__PURE__*/function (_CommandBase) {
  ...
  (0, _createClass2.default)(CopyAll, [{
    ...
    value: function apply() {
      $e.run('document/elements/copy', {
        containers: (0, _values.default)(matportal.getPreviewView().children._views).map(function (view) {
  ...
  (0, _createClass2.default)(Create, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        ...
        model: model,
        type: 'add',
        title: matportal.helpers.getModelLabel(model)
      };
    }
  }, {
    key: "apply",
  ...
  (0, _createClass2.default)(Delete, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        matportal.channels.data.trigger('element:before:remove', container.model);
        container.model.destroy(); // BC: Deprecated since 2.8.0 - use `$e.hooks`.

        matportal.channels.data.trigger('element:after:remove', container.model);
        container.panel.refresh();
      });
  ...
  (0, _createClass2.default)(Empty, [{
    ...
    value: function getHistory(args) {
      if (args.force) {
        return {
          type: 'remove',
          title: matportal.translate('all_content'),
          data: matportal.elements ? matportal.elements.toJSON() : null,
          restore: this.constructor.restore
        };
      }
    ...
    key: "apply",
    value: function apply(args) {
      if (args.force && matportal.elements) {
        matportal.elements.reset();
        matportal.getPreviewContainer().panel.closeEditor();
        return;
      }

      matportal.getClearPageDialog().show();
    }
  }, {
    key: "isDataChanged",
    value: function isDataChanged() {
    ...
    value: function restore(historyItem, isRedo) {
      if (isRedo) {
        ...
        if (data) {
          matportal.getPreviewView().addChildModel(data);
        }
...
var Import = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(Import, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        type: 'add',
        title: matportal.translate('template'),
    ...
    value: function apply(args) {
      var data = args.data,
          ...
          previewContainer = matportal.getPreviewContainer(),
          result = [];
      ...
      if (options.withPageSettings) {
        $e.run('document/elements/settings', {
          container: matportal.settings.page.getEditedView().getContainer(),
...
var Paste = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function validateArgs(args) {
      ...
      var _args$storageKey = args.storageKey,
          storageKey = _args$storageKey === void 0 ? 'clipboard' : _args$storageKey,
          storageData = matportalCommon.storage.get(storageKey);
    ...
    value: function getHistory() {
      return {
        type: 'paste',
        title: matportal.translate('elements')
      };
    }
  }, {
    key: "apply",
...
var Move = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function validateArgs(args) {
      this.requireContainer(args);
      this.requireArgumentInstance('target', matportalModules.editor.Container, args);
    }
  }, {
    key: "getHistory",
    value: function getHistory(args) {
      ...
      containers.forEach(function (targetContainer) {
        ...
        storageData.forEach(function (sourceModel) {
          ...
          (0, _entries.default)(targetControls).forEach(function (_ref) {
            ...
            if (controlSourceValue === controlTargetValue || !matportal.getControlView(control.type).onPasteStyle(control, controlSourceValue)) {
              return;
            }
          ...
          matportal.channels.data.trigger('element:before:paste:style', targetContainer.model);
          $e.run('document/elements/settings', {
            container: targetContainer,
          ...
          matportal.channels.data.trigger('element:after:paste:style', targetContainer.model);
  ...
  (0, _createClass2.default)(ResetStyle, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        ...
        matportal.channels.data.trigger('element:before:reset:style', container.model);
        ...
        matportal.channels.data.trigger('element:after:reset:style', container.model);
...
matportalCommon.elements.$window.on('matportal:init-components', function () {
  ...
  matportal.saver = $e.components.get('document/save');
});
    ...
    value: function defaultUtils() {
      ...
      return {
        ...
        findViewById: function findViewById(id) {
          var elements = _this.utils.findViewRecursive(matportal.getPreviewView().children, 'id', id, false);
...
var BackwardsCompatibility = /*#__PURE__*/function () {
  function BackwardsCompatibility() {
    (0, _classCallCheck2.default)(this, BackwardsCompatibility);
    matportalCommon.elements.$window.on('matportal:init', this.deprecatedEvents);
    matportal.channels.data.on('template:before:insert', this.startInsertTemplate).on('template:after:insert', this.endItem);
  }

  (0, _createClass2.default)(BackwardsCompatibility, [{
    key: "deprecatedEvents",
    value: function deprecatedEvents() {
      var matportalDataEvents = matportal.channels.data._events,
      ...
      deprecatedEvents.forEach(function (event) {
        if (matportalDataEvents[event] && matportalDataEvents[event].length) {
          matportalCommon.helpers.softDeprecated("event: ".concat(event), '2.8.0', '$e.hooks');
        }
      });
    }
  }, {
    ...
    value: function startInsertTemplate(model) {
      matportalCommon.helpers.softDeprecated('event: template:before:insert', '2.8.0', "$e.run( 'document/import' )");
      matportal.documents.getCurrent().history.startItem({
        type: 'add',
        title: matportal.translate('template'),
        subTitle: model.get('title'),
    ...
    value: function endItem() {
      matportal.documents.getCurrent().history.endItem();
    }
  }]);
  return BackwardsCompatibility;
}();
    ...
    value: function apply(args) {
      ...
      container) {
        if ('dynamic' === container.type) {
          var tagText = matportal.dynamicTags.tagContainerToTagText(container),
              commandArgs = {
  ...
  (0, _createClass2.default)(ResizeColumn, [{
    ...
    value: function resizeColumn(container, newSize) {
      ...
      if (undefined === container.oldValues || null === container.oldValues._inline_size) {
        ...
        var totalWidth = parentView.$el.find(' > .matportal-container')[0].getBoundingClientRect().width;
      ...
      $e.run('document/elements/settings', {
        ...
        options: {
          ...
          history: {
            title: matportal.config.elements.column.controls._inline_size.label
          },
          external: true,
          debounce: true
        }
...
var Component = /*#__PURE__*/function (_BackwardsCompatibili) {
  ...
  (0, _createClass2.default)(Component, [{
    ...
    value: function __construct() {
      ...
      this.autoSaveInterval = matportal.config.autosave_interval * 1000;
      matportalCommon.elements.$window.on('beforeunload', function () {
        if (_this2.isEditorChanged()) {
          // Returns a message to confirm dialog.
          return matportal.translate('before_unload_alert');
        }
      });
    }
  }, {
    ...
    value: function isEditorChanged() {
      return true === matportal.channels.editor.request('status');
    }
  }]);
  return Component;
  ...
  (0, _createClass2.default)(BackwardsCompatibility, [{
    ...
    value: function __construct() {
      ...
      (0, _defineProperty.default)(this, 'autoSaveTimer', {
        get: function get() {
          matportalCommon.helpers.softDeprecated('matportal.saver.autoSaveTimer', '2.9.0', "$e.components.get( 'editor/documents' ).autoSaveTimers");
          return $e.components.get('editor/documents').autoSaveTimers;
        },
        set: function set(value) {
          matportalCommon.helpers.softDeprecated('matportal.saver.autoSaveTimer', '2.9.0', "$e.components.get( 'editor/documents' ).autoSaveTimers[ documentId ]");
          var documentId = matportal.documents.getCurrent();
      ...
      this.on = function (eventName, callback, context) {
        matportalCommon.helpers.softDeprecated('matportal.saver.on', '2.9.0', '$e.hooks');
        onOrig(eventName, callback, context);
      };

      matportal.on('document:loaded', function () {
        if (matportal.channels.editor._events && matportal.channels.editor._events.saved) {
          matportalCommon.helpers.softDeprecated("matportal.channels.editor.on( 'saved', ... )", '2.9.0', '$e.hooks');
        }
      });
    }
  }, {
    ...
    value: function defaultSave() {
      matportalCommon.helpers.softDeprecated('defaultSave', '2.9.0', "$e.run( 'document/save/default' )");
      return $e.run('document/save/default');
    }
  }, {
    key: "discard",
    value: function discard() {
      matportalCommon.helpers.softDeprecated('discard', '2.9.0', "$e.run( 'document/save/discard' )");
      return $e.run('document/save/discard');
    }
  }, {
    key: "doAutoSave",
    value: function doAutoSave() {
      matportalCommon.helpers.softDeprecated('doAutoSave', '2.9.0', "$e.run( 'document/save/auto' )");
      return $e.run('document/save/auto');
    }
  }, {
    key: "publish",
    value: function publish(options) {
      matportalCommon.helpers.softDeprecated('publish', '2.9.0', "$e.run( 'document/save/publish' )");
      return $e.run('document/save/auto', {
        options: options
      });
    }
    ...
    value: function saveAutoSave(options) {
      matportalCommon.helpers.softDeprecated('saveAutoSave', '2.9.0', "$e.run( 'document/save/auto', { force: true } )");
      options.force = true;
    ...
    value: function saveDraft() {
      matportalCommon.helpers.softDeprecated('saveDraft', '2.9.0', "$e.run( 'document/save/draft' )");
      return $e.run('document/save/draft');
    }
  }, {
    key: "savePending",
    value: function savePending() {
      matportalCommon.helpers.softDeprecated('savePending', '2.9.0', "$e.run( 'document/save/pending' )");
      return $e.run('document/save/pending');
    }
  }, {
    key: "update",
    value: function update(options) {
      matportalCommon.helpers.softDeprecated('update', '2.9.0', "$e.run( 'document/save/update' )");
      return $e.run('document/save/update', options);
    }
  }, {
    key: "startTimer",
    value: function startTimer() {
      matportalCommon.helpers.softDeprecated('startTimer', '2.9.0', "$e.components.get( 'document/save' ).startAutoSave");
      throw Error('Deprecated');
    }
  }, {
    key: "saveEditor",
    value: function saveEditor(options) {
      matportalCommon.helpers.softDeprecated('saveEditor', '2.9.0', "$e.internal( 'document/save/save' )");
      $e.internal('document/save/save', options);
    }
  }, {
    key: "setFlagEditorChange",
    value: function setFlagEditorChange(status) {
      matportalCommon.helpers.softDeprecated('setFlagEditorChange', '2.9.0', "$e.internal( 'document/save/set-is-modified' )");
      $e.internal('document/save/set-is-modified', {
        status: status
      });
    }
...
var Discard = /*#__PURE__*/function (_Base) {
  ...
  (0, _createClass2.default)(Discard, [{
    ...
    value: function apply(args) {
      var _args$document = args.document,
          document = _args$document === void 0 ? matportal.documents.getCurrent() : _args$document; // Start server request before undo, because the undo can take time.

      var deferred = matportalCommon.ajax.addRequest('discard_changes');
...
var Save = /*#__PURE__*/function (_CommandInternalBase) {
  ...
  (0, _createClass2.default)(Save, [{
    ...
    value: function apply(args) {
      ...
      matportal.saver.trigger('before:save', args).trigger('before:save:' + status, args);
      document.editor.isSaving = true;
      document.editor.isChangedDuringSave = false;
      settings.post_status = status;
      var elements = [];

      if (matportal.config.document.panel.has_elements) {
      ...
      var deferred = matportalCommon.ajax.addRequest('save_builder', {
        data: {
          status: status,
          elements: elements,
          settings: settings
      ...
      matportal.saver.trigger('save', args);
      return deferred;
    }
  }, {
    key: "onSaveSuccess",
    value: function onSaveSuccess(data, args) {
      ...
      matportal.documents.invalidateCache(document.id);
      ...
      if (document !== matportal.documents.getCurrent()) {
        return result;
      }
      ...
      matportal.channels.editor.trigger('saved', data); // TODO: Remove - Backwards compatibility

      matportal.saver.trigger('after:save', data).trigger('after:save:' + status, data); // TODO: Remove - Backwards compatibility

      if (statusChanged) {
        matportal.saver.trigger('page:status:change', status, oldStatus);
      }
    ...
    value: function onSaveError(data, status, document) {
      ...
      matportal.saver.trigger('after:saveError', data).trigger('after:saveError:' + status, data);
      var message;

      if (_.isString(data)) {
        message = data;
      } else if (data.statusText) {
        message = matportal.createAjaxErrorMessage(data);

        if (0 === data.readyState) {
          message += ' ' + matportal.translate('saving_disabled');
        }
      } else if (data[0] && data[0].code) {
        message = matportal.translate('server_error') + ' ' + data[0].code;
      }

      matportal.notifications.showToast({
        message: message
      });
    }
  }, {
...
var SetIsModified = /*#__PURE__*/function (_CommandInternalBase) {
  ...
  (0, _createClass2.default)(SetIsModified, [{
    ...
    value: function apply(args) {
      var status = args.status,
          _args$document = args.document,
          document = _args$document === void 0 ? matportal.documents.getCurrent() : _args$document; // Save document for hooks.
      ...
      matportal.channels.editor.reply('status', status).trigger('status:change', status);
...
var FooterSaverAfterSave = /*#__PURE__*/function (_HookUIAfter) {
  ...
  (0, _createClass2.default)(FooterSaverAfterSave, [{
    ...
    value: function apply(args, result) {
      ...
      NProgress.done();
      footerSaver.ui.buttonPublish.removeClass('matportal-button-state');
      footerSaver.ui.lastEditedWrapper.removeClass('matportal-state-active');
    ...
    value: function onPageStatusChange(newStatus) {
      if ('publish' === newStatus) {
        ...
        if (matportal.config.document.urls.have_a_look) {
          buttons.push({
            name: 'view_page',
            text: matportal.translate('have_a_look'),
            callback: function callback() {
              open(matportal.config.document.urls.have_a_look);
            }
          });
        }

        matportal.notifications.showToast({
          message: matportal.config.document.panel.messages.publish_notification,
          buttons: buttons
        });
      }
    }
...
var FooterSaverBeforeSave = /*#__PURE__*/function (_HookUIBefore) {
  ...
  (0, _createClass2.default)(FooterSaverBeforeSave, [{
    ...
    value: function apply(args) {
      ...
      if ('autosave' === status) {
        footerSaver.ui.lastEditedWrapper.addClass('matportal-state-active');
      } else {
        footerSaver.ui.buttonPublish.addClass('matportal-button-state');
      }
    }
  }]);
...
var FooterSaverCatchSave = /*#__PURE__*/function (_HookUICatch) {
  ...
  (0, _createClass2.default)(FooterSaverCatchSave, [{
    ...
    value: function apply() {
      NProgress.done();
      $e.components.get('document/save').footerSaver.ui.buttonPublish.removeClass('matportal-button-state');
    }
  }]);
...
var Copy = /*#__PURE__*/function (_CommandBase) {
  ...
  (0, _createClass2.default)(Copy, [{
    key: "apply",
    value: function apply() {
      var selectedElement = matportal.getCurrentElement();
...
var Paste = /*#__PURE__*/function (_CommandBase) {
  ...
  (0, _createClass2.default)(Paste, [{
    ...
    value: function initialize(args) {
      ...
      this.storage = matportalCommon.storage.get('clipboard');
      this.storage = this.storage.map(function (model) {
        return new Backbone.Model(model);
      });

      if (!containers[0]) {
        this.target = matportal.getCurrentElement();
  ...
  (0, _createClass2.default)(Duplicate, [{
    ...
    value: function getHistory(args) {
      ...
      return {
        containers: containers,
        type: 'duplicate',
        subTitle: matportal.translate('Item')
      };
    }
  }, {
    key: "apply",
...
var Insert = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(Insert, [{
    ...
    value: function initialize(args) {
      ...
      if (!args.model._id) {
        args.model._id = matportal.helpers.getUniqueID();
      }
    }
  }, {
    key: "validateArgs",
...
var Move = /*#__PURE__*/function (_History) {
  ...
  (0, _createClass2.default)(Move, [{
    ...
    value: function apply(args) {
      ...
      containers.forEach(function (container) {
        var collection = container.settings.get(name),
            model = matportalCommon.helpers.cloneObject(collection.at(sourceIndex));
        $e.run('document/repeater/remove', {
          container: container,
          name: name,
          index: sourceIndex
    ...
    value: function getCommands() {
      return {
        do: function _do(args) {
          return matportal.documents.getCurrent().history.doItem(args.index);
        },
        undo: function undo() {
          return matportal.documents.getCurrent().history.navigate();
        },
        ...
        redo: function redo() {
          return matportal.documents.getCurrent().history.navigate(true);
        }
      };
    }
  }, {
    ...
    value: function normalizeLogTitle(args) {
      ...
      if (!args.title && containers[0]) {
        if (1 === containers.length) {
          ...
          args.title = matportal.translate('elements');
        }
      }
