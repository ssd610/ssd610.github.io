...
module.exports = matportalModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      element: null,
      direction: matportalFrontend.config.is_rtl ? 'right' : 'left',
      selectors: {
        container: window
      }
    };
...
module.exports = matportalModules.ViewModule.extend({
  ...
  __construct: function __construct(settings) {
    ...
    this.isEdit = this.$element.hasClass('matportal-element-edit-mode');
  ...
  findElement: function findElement(selector) {
    ...
    return $mainElement.find(selector).filter(function () {
      return jQuery(this).closest('.matportal-element').is($mainElement);
    });
  },
  ...
  initEditorListeners: function initEditorListeners() {
    ...
    ['page', 'general'].forEach(function (settingsType) {
      ...
      if (self[listenerMethodName]) {
        self.editorListeners.push({
          event: 'change',
          to: matportal.settings[settingsType].model,
  ...
  addEditorListeners: function addEditorListeners() {
    ...
    this.getEditorListeners().forEach(function (listener) {
      matportalFrontend.addListenerOnce(uniqueHandlerID, listener.event, listener.callback, listener.to);
    });
  },
  removeEditorListeners: function removeEditorListeners() {
    var uniqueHandlerID = this.getUniqueHandlerID();
    this.getEditorListeners().forEach(function (listener) {
      matportalFrontend.removeListeners(uniqueHandlerID, listener.event, null, listener.to);
    });
  },
  ...
  getElementSettings: function getElementSettings(setting) {
    ...
    if (this.isEdit && modelCID) {
      var settings = matportalFrontend.config.elements.data[modelCID],
      ...
      var settingsKeys = matportalFrontend.config.elements.keys[type];

      if (!settingsKeys) {
        settingsKeys = matportalFrontend.config.elements.keys[type] = [];
  ...
  getEditSettings: function getEditSettings(setting) {
    ...
    if (this.isEdit) {
      attributes = matportalFrontend.config.elements.editSettings[this.getModelCID()].attributes;
    }

    return this.getItems(attributes, setting);
  },
  getCurrentDeviceSetting: function getCurrentDeviceSetting(settingKey) {
    return matportalFrontend.getCurrentDeviceSetting(this.getElementSettings(), settingKey);
  },
