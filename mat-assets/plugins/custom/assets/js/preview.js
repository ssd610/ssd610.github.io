...
var Preview = /*#__PURE__*/function (_matportalModules$Vie) {
  (0, _inherits2.default)(Preview, _matportalModules$Vie);
  ...
  function Preview() {
    ...
    matportalFrontend.on('components:init', function () {
  ...
  (0, _createClass2.default)(Preview, [{
    ...
    value: function createDocumentsHandles() {
      ...
      jQuery.each(matportalFrontend.documentsManager.documents, function (index, document) {
        var $documentElement = document.$element;

        if ($documentElement.hasClass('matportal-edit-mode')) {
          return;
        }

        var $existingHandle = document.$element.children('.matportal-document-handle');
        ...
        var $handle = jQuery('<div>', {
          class: 'matportal-document-handle'
        }),
            $handleIcon = jQuery('<i>', {
          class: 'eicon-edit'
        }),
            documentTitle = $documentElement.data('matportal-title'),
            $handleTitle = jQuery('<div>', {
          class: 'matportal-document-handle__title'
        }).text(matportal.translate('edit_element', [documentTitle]));
    ...
    value: function onDocumentHandleClick(document) {
      matportalCommon.api.run('editor/documents/switch', {
...
window.matportalProPreview = new Preview();
