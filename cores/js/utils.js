 ...
 * Cookie functions.
 *
 * @output matindia-includes/js/utils.js
 */
...
window.setUserSetting = function( name, value, _del ) {
	...
	var uid = userSettings.uid,
		settings = wpCookies.getHash( 'matindia-settings-' + uid ),
	...
	wpCookies.setHash( 'matindia-settings-' + uid, settings, 31536000, path, '', secure );
	wpCookies.set( 'matindia-settings-time-' + uid, userSettings.time, 31536000, path, '', secure );
...
window.getAllUserSettings = function() {
	...
	return wpCookies.getHash( 'matindia-settings-' + userSettings.uid ) || {};
};
