...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	createToolbar: function() {
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			toolbarOptions.className = 'media-toolbar matindia-filter';
		}
...
MediaFrame = Frame.extend(/** @lends wp.media.view.MediaFrame.prototype */{
	...
	initialize: function() {
		...
		this.$el.addClass('matindia-core-ui');
...
/**
 * Creates a dropzone on WP editor instances (elements with .matindia-editor-wrap)
...
EditorUploader = View.extend(/** @lends wp.media.view.EditorUploader.prototype */{
	...
	render: function() {
		...
		View.prototype.render.apply( this, arguments );
		$( '.matindia-editor-wrap' ).each( _.bind( this.attach, this ) );
		return this;
	},
	...
	drop: function( event ) {
		...
		$wrap = $( event.target ).parents( '.matindia-editor-wrap' );
...
!function() {
/**
 * @output matindia-includes/js/media-views.js
 */
