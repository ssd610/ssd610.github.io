 ...
 *
 * Keys are crucially prefixed with 'matindia-autosave-' so that matindia-login.php's
 * `loggedout` handler can clear sessionStorage of any user-private content.
 *
 * @see https://github.com/WordPress/wordpress-develop/blob/6dad32d2aed47e6c0cf2aee8410645f6d7aba6bd/src/matindia-login.php#L103
 *
...
function postKey(postId, isPostNew) {
  return `matindia-autosave-block-editor-post-${isPostNew ? 'auto-draft' : postId}`;
}
...
function PostLockedModal() {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    function sendPostLock(data) {
      ...
      data['matindia-refresh-post-lock'] = {
        lock: activePostLock,
        post_id: postId
      };
    }
    ...
    function receivePostLock(data) {
      if (!data['matindia-refresh-post-lock']) {
        return;
      }

      const received = data['matindia-refresh-post-lock'];
    ...
    function releasePostLock() {
      ...
      data.append('action', 'matindia-remove-post-lock');
...
class PostPreviewButton extends external_wp_element_namespaceObject.Component {
  ...
  getWindowTarget() {
    ...
    return `matindia-preview-${postId}`;
  }
...
function PostTitle(_, forwardedRef) {
  ...
  } // The matindia-block className is important for editor styles.
  // This same block is used in both the visual and the code editor.


  const className = classnames_default()('matindia-block matindia-block-post-title block-editor-block-list__block editor-post-title editor-post-title__input rich-text', {
