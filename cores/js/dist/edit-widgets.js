...
function WidgetAreaInnerBlocks({
  ...
  return (0,external_wp_element_namespaceObject.createElement)("div", {
    ...
    className: classnames_default()('matindia-block-widget-area__inner-blocks block-editor-inner-blocks editor-styles-wrapper', {
      'matindia-block-widget-area__highlight-drop-zone': shouldHighlightDropZone
    })
...
function WidgetAreaEdit({
  ...
  (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.__unstableDisclosureContent, {
    className: "matindia-block-widget-area__panel-body-content",
    visible: opened
...
const metadata = {
  ...
  editorStyle: "matindia-block-widget-area-editor",
  style: "matindia-block-widget-area"
};
