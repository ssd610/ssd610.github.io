...
const VIEW_AS_LINK_SELECTOR = '#matindia-admin-bar-view a';
/**
...
const VIEW_AS_PREVIEW_LINK_SELECTOR = '#matindia-admin-bar-preview a';
...
function VisualEditor({
  ...
  const alignCSS = `.is-root-container.alignwide { max-width: var(--matindia--style--global--wide-size); margin-left: auto; margin-right: auto;}
		.is-root-container.alignwide:where(.is-layout-flow) > :not(.alignleft):not(.alignright) { max-width: var(--matindia--style--global--wide-size);}
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_blockEditor_namespaceObject.BlockTools, {
    ...
    className: isTemplateMode ? 'matindia-site-blocks' : `${blockListLayoutClass} matindia-block-post-content` // Ensure root level blocks receive default/flow blockGap styling rules.
    ,
    layout: blockListLayout
  }))))));
}
