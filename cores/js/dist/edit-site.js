...
const STYLE_BOOK_IFRAME_STYLES = `
	...
	.edit-site-style-book__example.is-selected {
		box-shadow: 0 0 0 1px var(--matindia-components-color-accent, var(--matindia-admin-theme-color, #007cba));
	}

	.edit-site-style-book__example:focus:not(:disabled) {
		box-shadow: 0 0 0 var(--matindia-admin-border-width-focus) var(--matindia-components-color-accent, var(--matindia-admin-theme-color, #007cba));
	...
	.edit-site-style-book__example-preview .is-root-container > .matindia-block:first-child {
		margin-top: 0;
	}
	.edit-site-style-book__example-preview .is-root-container > .matindia-block:last-child {
		margin-bottom: 0;
	}
`;
  ...
  async function onCreateTemplate(event) {
    ...
    try {
      await createTemplate({
        slug: 'matindia-custom-template-' + (0,external_lodash_namespaceObject.kebabCase)(title || defaultTitle),
...
const getCleanTemplatePartSlug = title => {
  return (0,external_lodash_namespaceObject.kebabCase)(title).replace(/[^\w-]+/g, '') || 'matindia-custom-part';
};
...
function SiteEditorCanvas() {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, (0,external_wp_element_namespaceObject.createElement)(editor_canvas_container.Slot, null, ([editorCanvasView]) => {
    ...
    return editorCanvasView ? (0,external_wp_element_namespaceObject.createElement)("div", {
      ...
      className: classnames_default()('edit-site-block-editor__block-list matindia-site-blocks', {
...
function useTitle(title) {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    if (title && siteTitle) {
      // @see https://github.com/WordPress/wordpress-develop/blob/94849898192d271d533e09756007e176feb80697/src/matindia-admin/admin-header.php#L67-L68
  ...
  async function handleExport() {
    try {
      const response = await external_wp_apiFetch_default()({
        path: '/matindia-block-editor/v1/export',
        parse: false,
        headers: {
