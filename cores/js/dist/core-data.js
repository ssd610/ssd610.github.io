...
const resolvers_getNavigationFallbackId = () => async ({
  ...
  const fallback = await external_wp_apiFetch_default()({
    path: (0,external_wp_url_namespaceObject.addQueryArgs)('/matindia-block-editor/v1/navigation-fallback', {
      _embed: true
    })
  });
...
const fetchUrlData = async (url, options = {}) => {
  const endpoint = '/matindia-block-editor/v1/url-details';
  const args = {
