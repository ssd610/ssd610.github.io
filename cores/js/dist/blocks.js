...
const __EXPERIMENTAL_STYLE_PROPERTY = {
  ...
  '--matindia--style--root--padding': {
    value: ['spacing', 'padding'],
    support: ['spacing', 'padding'],
    properties: {
      '--matindia--style--root--padding-top': 'top',
      '--matindia--style--root--padding-right': 'right',
      '--matindia--style--root--padding-bottom': 'bottom',
      '--matindia--style--root--padding-left': 'left'
    },
    rootOnly: true
  }
};
const __EXPERIMENTAL_ELEMENTS = {
  ...
  h5: 'h5',
  h6: 'h6',
  button: '.matindia-element-button, .matindia-block-button__link',
  caption: '.matindia-element-caption, .matindia-block-audio figcaption, .matindia-block-embed figcaption, .matindia-block-gallery figcaption, .matindia-block-image figcaption, .matindia-block-table figcaption, .matindia-block-video figcaption',
  cite: 'cite'
};
...
function getBlockDefaultClassName(blockName) {
  // Generated HTML classes for blocks follow the `matindia-block-{name}` nomenclature.
  // Blocks provided by WordPress drop the prefixes 'core/' or 'core-' (historically used in 'core-embed/').
  const className = 'matindia-block-' + blockName.replace(/\//, '-').replace(/^core-/, '');
...
function convertLegacyBlockNameAndAttributes(name, attributes) {
  ...
  if (name === 'core/comments-query-loop') {
    ...
    if (!className.includes('matindia-block-comments-query-loop')) {
      newAttributes.className = ['matindia-block-comments-query-loop', className].join(' ');
...
function createMore(customText, noTeaser, doc) {
  const node = doc.createElement('matindia-block');
