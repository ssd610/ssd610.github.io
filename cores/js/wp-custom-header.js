/**
 * @output matindia-includes/js/matindia-custom-header.js
 */
...
(function( window, settings ) {
			...
			if ( this.supportsVideo() ) {
				for ( var id in this.handlers ) {
					...
					if ( 'test' in handler && handler.test( settings ) ) {
						...
						trigger( document, 'matindia-custom-header-video-loaded' );
						break;
					}
				}
			}
	...
	BaseHandler.prototype = {
		...
		initialize: function( settings ) {
			...
			this.container = document.getElementById( 'matindia-custom-header' );
			this.button = button;

			button.setAttribute( 'type', 'button' );
			button.setAttribute( 'id', 'matindia-custom-header-video-button' );
			button.setAttribute( 'class', 'matindia-custom-header-video-button matindia-custom-header-video-play' );
			...
			this.container.addEventListener( 'play', function() {
				button.className = 'matindia-custom-header-video-button matindia-custom-header-video-play';
			...
			this.container.addEventListener( 'pause', function() {
				button.className = 'matindia-custom-header-video-button matindia-custom-header-video-pause';
				button.innerHTML = settings.l10n.play;
				if ( 'a11y' in window.wp ) {
	...
	NativeHandler = BaseHandler.extend(/** @lends wp.NativeHandler.prototype */{
		...
		ready: function() {
			...
			video.id = 'matindia-custom-header-video';
			video.autoplay = true;
			video.loop = true;
			video.muted = true;
