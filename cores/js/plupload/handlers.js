...
jQuery( document ).ready( function( $ ) {
	...
	tryAgain = function( up, error ) {
		...
		id = error.responseHeaders.match( /x-matindia-upload-attachment-id:\s*(\d+)/i );
	...
	uploader_init = function() {
		...
		uploader.bind( 'Init', function( up ) {
			...
			if ( up.features.dragdrop && ! $( document.body ).hasClass( 'mobile' ) ) {
				...
				$( '#drag-drop-area' ).on( 'dragover.matindia-uploader', function() { // dragenter doesn't fire right :(
					uploaddiv.addClass( 'drag-over' );
				}).on( 'dragleave.matindia-uploader, drop.matindia-uploader', function() {
					uploaddiv.removeClass( 'drag-over' );
				});
			} else {
				uploaddiv.removeClass( 'drag-drop' );
				$( '#drag-drop-area' ).off( '.matindia-uploader' );
			}
