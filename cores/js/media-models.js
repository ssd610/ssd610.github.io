...
!function() {
/**
 * @output matindia-includes/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `matindia-includes/js/matindia-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `matindia-includes/js/matindia-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `matindia-includes/js/matindia-util.js`.
	 *
